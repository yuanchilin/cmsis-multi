...
elseif(CPU STREQUAL "Cortex-M3")
  # Keep armv7m (not thumbv7m) to match picolibc's runtime directory naming
  # (armv7m_soft_nofp_exn_rtti). The runtime library search path and crt0.o
  # are added explicitly via LD_FLAGS below to work around the CMSIS-Build
  # vs LLVM-ET-Arm 19.x multilib compatibility issue.
...
# Add picolibc runtime library path and crt0.o for Cortex-M3.
# CMSIS-Build expands -mcpu=cortex-m3 into -march=thumbv7m+* which blocks
# clang's automatic multilib runtime lookup. These flags are appended to
# LD_CPU to ensure the correct picolibc runtime (armv7m_soft_nofp_exn_rtti)
# is linked.
set(LD_CPU ${CLANG_CPU})
if(CPU STREQUAL "Cortex-M3")
  set(PICOLIBC_RUNTIME "${TOOLCHAIN_ROOT}/../lib/clang-runtimes/arm-none-eabi/armv7m_soft_nofp_exn_rtti")
  set(LD_CPU "${LD_CPU} -L${PICOLIBC_RUNTIME}/lib ${PICOLIBC_RUNTIME}/lib/crt0.o")
endif()
set(_LS "-T ")
